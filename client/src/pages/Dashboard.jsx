...
import { FileCheck, FileX, Files, Copy, Target, Filter } from "lucide-react";
import {
  PieChart,
  Pie,
  Cell,
...
const Dashboard = () => {
  ...
  const summaryCards = summary
    ? [
        ...
        {
          label: "Unmatched",
          value: formatNumber(summary.notMatched),
          icon: FileX,
          color: "bg-red-500",
        },
        {
          label: "Duplicates",
          value: formatNumber(summary.duplicate),
          icon: Copy,
          color: "bg-orange-500",
        },
        {
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-500 mt-1">
            Overview of reconciliation status and trends
          </p>
        </div>
      </div>
                ...
                <ResponsiveContainer width="100%" height={300}>
                  <BarChart
                    data={[
                      ...
                      {
                        name: "Partial",
                        count: summary.partiallyMatched,
                        fill: chartColors.partially_matched,
                      },
                      {
                        name: "Unmatched",
                        count: summary.notMatched,
                        fill: chartColors.not_matched,
                      },
                      {
                        name: "Duplicate",
                        count: summary.duplicate,
                        fill: chartColors.duplicate,
                      },
                    ]}
                  >
                    ...
                    <Bar dataKey="count" radius={[4, 4, 0, 0]}>
                      {[
                        chartColors.matched,
                        chartColors.partially_matched,
                        chartColors.not_matched,
                        chartColors.duplicate,
                      ].map((color, index) => (
